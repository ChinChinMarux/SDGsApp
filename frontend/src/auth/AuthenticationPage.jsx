...
function CustomAuthLayout() {
  ...
  const baseAppearance = {
    elements: {
      ...
      formFieldInput:
        "rounded-lg bg-gray-100 h-12 border border-gray-300 hover:border-blue-500 focus:border-blue-500 focus:ring-2 focus:ring-blue-200",
      formFieldLabel: "font-medium text-gray-800 mb-2",
      formButtonPrimary:
        "h-12 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-base font-semibold",
      socialButtonsBlockButton:
        "h-12 rounded-lg border-gray-300 text-gray-600 hover:border-blue-500 hover:bg-blue-50",
      ...
      <Container maxWidth="lg" sx={{ width: "850px" }}>
        <CustomPaper elevation={8}>
          ...
          <LeftPanel>
            ...
            >
              Aplikasi pemetaan publikasi ke dalam topik SDGs dan visualisasi
