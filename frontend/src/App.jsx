...
// import MainProfile from "./pages/(GakKepake)MainProfile";
import {AuthenticationPage} from "./auth/AuthenticationPage"; // Pastikan path ini sesuai dengan struktur folder Anda
    ...
    <ClerkProvider publishableKey={clerkPubKey}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/sign-up" element={<AuthenticationPage />} />2
