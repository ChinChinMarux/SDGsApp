...
const ProfileContent = ({ isDarkMode }) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ mb: 4 }}>
        <Typography variant="body2" sx={{ color: textColor, fontWeight: 600, mb: 2 }}>
          Profile Picture
        </Typography>
        <Box sx={{ 
          display: 'flex', 
          ...
          <Box>
            <Typography variant="body2" sx={{ fontWeight: 600, color: textColor, mb: 0.5 }}>
              Upload a new profile picture
            </Typography>
            <Typography variant="caption" sx={{ color: isDarkMode ? '#9399b2' : '#666' }}>
